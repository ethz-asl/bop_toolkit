...
p = {
    ...
    'renderer_type':
        'vispy',  # Options: 'vispy', 'cpp', 'python'.
    ...
    'out_errors_tpath':
        os.path.join('{eval_path}', '{result_name}', '{error_sign}',
...
for result_filename in p['result_filenames']:
    ...
    for scene_id, scene_targets in targets_org.items():
                ...
                for est_id, est in obj_ests_sorted:
                    ...
                    for gt_id, gt in enumerate(scene_gt[im_id]):
                        ...
                        if p['error_type'] in ['ad', 'add', 'adi', 'mssd']:
                            ...
                            spheres_overlap = center_dist < models_info[obj_id][
                                'diameter']
                        ...
                        if p['error_type'] == 'vsd':
                            ...
                            if not spheres_overlap:
                                ...
                                if p['error_type'] == 'ad':
                                    ...
                                    e = [
                                        pose_error.adi(R_e, t_e, R_g, t_g,
                                                       models[obj_id]['pts'])
                                    ]
        ...
        def save_errors(_error_sign, _scene_errs):
            ...
            errors_path = p['out_errors_tpath'].format(eval_path=p['eval_path'],
