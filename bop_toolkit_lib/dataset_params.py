...
def get_model_params(datasets_path, dataset_name, model_type=None):
  ...
  """
    ...
    symmetric_obj_ids = {
        ...
        'icbin': [1],
        'itodd': [
            2, 3, 4, 5, 7, 8, 9, 11, 12, 14, 17, 18, 19, 23, 24, 25, 27, 28
        ],
        'hbs': [10, 12, 18, 29],
...
def get_present_scene_ids(dp_split):
  ...
  """
    scene_dirs = [
        d for d in glob.glob(os.path.join(dp_split['split_path'], '*'))
        if os.path.isdir(d)
    ]
